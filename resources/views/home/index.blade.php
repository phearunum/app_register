            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <canvas id="order-chart" style="display: block; height: 161px; width: 323px;" width="646" height="322" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <canvas id="sales-chart" width="646" height="322" style="display: block; height: 161px; width: 323px;" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
        </div>
